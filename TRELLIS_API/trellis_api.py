#!/usr/bin/env python3
"""
FastAPI wrapper for TRELLIS image-to-3D pipeline
"""
import os
import sys
import asyncio
...
app = FastAPI(title="TRELLIS 3D Asset Generator", version="1.0.0")
    ...
    try:
        ...
        try:
            outputs = pipeline.run(
                ...
                preprocess_image=True,  # Enable preprocessing for better results
...
async def root():
    ...
    return {
        "service": "TRELLIS 3D Asset Generator",
        "version": "1.0.0",
        "status": "running",
        "endpoints": {
            "POST /generate": "Generate 3D asset from image",
